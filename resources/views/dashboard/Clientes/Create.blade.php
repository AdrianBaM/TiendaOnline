    ...
    <form action="{{route('clientes.store')}}" method="post"> 
        ...
        <section class="row 6">
            ...
            <article class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> <!-- si -->
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="Direccion1" class="form-control form-floating mb-3" placeholder="Direccion1" >
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="Direccion2" class="form-control form-floating mb-3" placeholder="Direccion2" >
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="Direccion3" class="form-control form-floating mb-3" placeholder="Direccion3" >
                ...
                <center><button type="" class="btn btn-outline-warning btn-lg"><h4>Guardar</h4></button><br>
                    <a href="{{route('clientes.index')}}" class="btn btn-info mt-3">Regresar</a>
