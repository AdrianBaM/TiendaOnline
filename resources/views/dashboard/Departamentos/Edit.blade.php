...
<body>
    <header>
        ...
        <br>
        <center><h1 class="mb-5">Actualizar Departamento</h1></center>
    </header>
        ...
        <section class="row 6">
            ...
            <article class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> <!-- si -->
                <div class="form-floating mb-3">
                    <input type="text" name="Depto" class="form-control form-floating mb-3" placeholder="Depto" value="{{$departamento->Depto}}">
                ...
                <center><button type="" class="btn btn-outline-warning btn-lg"><h4>Guardar</h4></button><br>
                    <a href="{{route('departamentos.index')}}" class="btn btn-info mt-3">Regresar</a>
